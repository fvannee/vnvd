...
namespace Vnvd
{
   ...
   /// Most methods in this class are adapted from the blog: http://dotneteers.net/blogs/divedeeper/archive/2008/08/03/ParsingCSharpStrings.aspx
   /// which explains in depth how to parse C# string literals
   /// </summary>
   public static class StringHelper
   {
      ...
      /// <returns>Normal string representation.</returns>
      ...
      /// </summary>
      /// <param name="source">Source C# literal string.</param>
      /// <returns>Normal char representation.</returns>
